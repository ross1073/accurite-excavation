...
keywords:
  ...
  secondary:
    - "septic contractor Weber County"
    - "septic tank installation Utah"
    - "perc test Utah"
...
faqs:
  ...
  - question: "How much does a perc test cost in Utah?"
    answer: "Perc tests in Weber and Davis counties run $750-$1,900 depending on the number of test holes required and site conditions. We can coordinate perc testing as part of your septic project."
  - question: "How long does septic system installation take?"
    answer: "Most residential septic installations take 3-5 days of excavation work. The full timeline from perc test to final inspection is typically 4-8 weeks, largely depending on permit processing time."
  - question: "Should I repair or replace my septic system?"
    answer: "If your system is over 25 years old and failing, replacement is usually more cost-effective than repeated repairs. We can assess your current system and give you an honest recommendation."
  - question: "What are the soil requirements for a septic system in Utah?"
    answer: "The soil must pass a percolation test to prove it can absorb effluent. Heavy clay soils common in the Ogden area may require engineered systems or mound systems. Rocky soils in the Ogden Valley can also complicate installation."
relatedServices:
...
1. Perc test and soil evaluation, coordinated through a certified soil scientist. Cost: $750-$1,900 depending on site.
2. System design prepared by the contractor or a licensed engineer, based on perc test results.
3. Permit application to Weber County Health Department. Fee: $535 plus $40 UDEQ fee, totaling $575.
4. County review and permit issuance. This typically takes 2-4 weeks.
5. Excavation and installation, with county inspection at rough grade before backfill.
6. Final backfill and site grading, followed by final inspection.
...
Septic installation is excavation work. The quality of the trench, the slope, the bedding material, and the backfill and compaction all determine how long the system performs. We bring the same precision to a septic project that we bring to a foundation dig or a [residential excavation](/services/residential-excavation).

We also handle related work: [underground utility](/services/underground-utilities) connections, [grading and site prep](/services/grading-land-clearing), and hookups to water lines. For a new rural home build, we can often handle the septic, the utilities, and the site prep as a single coordinated scope.
