---
title: "Excavation Services in Roy, UT"
description: "AccuRite Excavation serves Roy, Utah with residential excavation, site prep, utility work, and grading. Weber County permitted. Call (801) 814-6975."
city: "Roy"
county: "Weber"
metaTitle: "Excavation Contractor in Roy, UT | AccuRite Excavation"
metaDescription: "Roy Utah excavation contractor. Foundation digs, utility replacement, grading, and site prep for new construction. Weber County permitted. Call (801) 814-6975."
localIntro: "Roy sits on flat ground west of I-15, sandwiched between Ogden and Clearfield in Weber County's central corridor. The terrain is straightforward: no steep bench lots, no significant rock, mostly flat land with clay soils that drain poorly without proper grading. What Roy does have is a mix of older established neighborhoods where utility infrastructure is aging out, and new residential development driven by affordable housing demand. AccuRite Excavation handles both ends of that spectrum."
permitInfo: "Roy City requires building permits for foundation excavation and grading work within city limits. For projects in unincorporated Weber County areas near Roy, permits go through Weber County Engineering instead. If you're not sure which jurisdiction applies to your address, we can help you figure that out before the project starts. Permit requirements vary by project size and scope."
soilInfo: "Roy's terrain is flat and the soils are predominantly clay with gravel layers appearing at depth. The clay expands with moisture and contracts when it dries, which creates foundation movement and drainage problems if the site isn't graded correctly from the start. Some areas west of town, closer to the Great Salt Lake lowlands, have higher water tables that require dewatering on deep excavations. The flat terrain makes equipment access easy, but the clay soils slow down digging compared to gravel or sandy sites."
faqs:
  - question: "What does excavation cost in Roy?"
    answer: "Residential excavation in Roy is typically on the lower end of Wasatch Front pricing because the terrain is flat and the soil, while heavy clay, doesn't require rock hammering. Most residential foundation digs run $3,500 to $9,000. Utility replacement work is priced by linear footage of trench and depth. We give free on-site estimates so you know what you're looking at before any commitment."
  - question: "My Roy home is older and I need the water line replaced. Can AccuRite handle that?"
    answer: "Yes. Utility replacement in older Roy neighborhoods is steady work for us. We trench for water line replacements, sewer lateral repairs, and gas line work throughout the city. The process involves a utility locate before we dig, proper trench depth and bedding for the pipe, and compacted backfill that won't settle unevenly. Roy City inspection is typically required on water and sewer work."
  - question: "Does AccuRite do site prep for new homes in Roy?"
