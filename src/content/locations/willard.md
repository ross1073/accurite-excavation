...
faqs:
  - question: "I'm on a large lot in Willard and need a septic system for a new home. How does that process work?"
    answer: "You'll need a perc test and an approved system design from a licensed engineer or designer before the Box Elder County Health Department will issue a septic permit. Once you have the permit and approved plans, we dig the tank pit and leach field trenches to spec. Your licensed septic installer handles the system components, and we backfill after they're done. We've worked through this process many times and can walk you through it."
  - question: "I have a property near Willard Bay. Are there any special concerns for excavation?"
...
Most of Willard doesn't have municipal sewer, which means [septic systems](/services/septic-systems) are the norm. We handle the excavation portion: the tank pit, distribution box pit if needed, and leach field trenches, all dug to your system designer's specifications.
...
Some Willard properties have terrain that needs management, particularly on lots that rise toward the foothills. Where grade changes would otherwise cause erosion or create unusable yard space, a [retaining wall](/services/rock-walls-retaining-walls) is often the right answer.
