---
title: "Excavation Services in Fruit Heights, UT"
description: "AccuRite Excavation serves Fruit Heights, Utah with hillside excavation, retaining walls, and foundation work. Specialists in bench terrain and premium residential lots. Call (801) 814-6975."
city: "Fruit Heights"
county: "Davis"
metaTitle: "Excavation Fruit Heights UT | AccuRite Excavation & Hauling"
metaDescription: "Fruit Heights UT excavation. Hillside lots, retaining walls, rock hammering on bench properties. Licensed since 1995. Call (801) 814-6975."
localIntro: "Fruit Heights occupies a narrow band of bench terrain on the east side of Davis County, perched above Kaysville and below the Wasatch mountain front. Nearly every lot in this small community involves some degree of slope, and the soil transitions quickly from Bonneville clay on the lower edge to rocky alluvium and weathered bedrock on the upper streets. This is premium residential territory where homes have valley views and mountain backdrops, and the excavation work reflects the demanding terrain that creates those views."
permitInfo: "Fruit Heights City handles building permits through its administration office. The city has hillside development standards that apply to most properties due to the bench terrain. Retaining walls over four feet, foundation excavation, and any grading that changes natural drainage patterns require permits. Geotechnical reports are commonly required for upper bench properties. We handle the permit process and coordinate with geotech engineers when their reports are needed."
soilInfo: "Fruit Heights soil reflects the bench geology. Lower properties near the Kaysville border sit on Bonneville-era clay and gravel deposits. Moving uphill, the ground quickly transitions to rocky alluvium — angular quartzite and limestone fragments in a sandy matrix. Upper Fruit Heights lots routinely hit bedrock within two to four feet. The bench position means good natural drainage compared to the valley floor, but slope stability and erosion become the primary concerns instead of water table management."
faqs:
  - question: "How much does it cost to excavate a hillside lot in Fruit Heights?"
    answer: "Hillside excavation in Fruit Heights is more expensive than valley floor work because of the rock, the slope, and the retaining wall work typically needed. A residential foundation dig on an upper Fruit Heights lot runs $8,000 to $20,000 depending on rock conditions, the amount of cut-and-fill required, and wall height. Lower lots closer to Kaysville with less slope and rock cost less. We do a site visit to assess conditions before quoting."
  - question: "Do all Fruit Heights lots need retaining walls?"
    answer: "Most do. The bench terrain means creating any level surface requires holding a grade change. Even lots with moderate slope typically need at least one retaining wall for the foundation pad, driveway cut, or yard terracing. Upper lots may need multiple walls. The type and height depend on the grade change and the loads involved. We build walls as part of the excavation project so everything is coordinated."
  - question: "What equipment do you use on steep Fruit Heights lots?"
    answer: "We match equipment to the access and terrain. Upper Fruit Heights lots with narrow access or steep approaches may require compact excavators that can work in tight spaces. For rock, we use hydraulic hammer attachments. Larger lots with better access allow full-size equipment that moves material faster. We assess access routes during the site visit to plan the right equipment mix."
projects: []
testimonials: []
---
...
The slope adds another dimension. Most Fruit Heights lots have a grade change of two to six feet or more across the building footprint. That means cut-and-fill earthwork is standard — cut into the uphill side, use that material to build up the downhill side, and hold everything with [retaining walls](/services/rock-walls-retaining-walls).
...
**[Residential excavation](/services/residential-excavation)** for new custom homes and major additions is our most frequent Fruit Heights work. **Retaining wall construction** accompanies nearly every project. **Driveway excavation and grading** is common on lots where the home sits above or below street grade. We also handle [demolition](/services/demolition) for tear-down rebuilds, which happen as older bench homes get replaced with new construction.

## Nearby Service Areas

Fruit Heights is bordered by [Kaysville](/locations/kaysville) below and [Farmington](/locations/farmington) to the north. We work all three communities regularly. The bench terrain is similar across this stretch of Davis County, so the equipment and expertise we bring to Fruit Heights applies throughout the area. [Layton](/locations/layton) is also close by, just east of Kaysville.
