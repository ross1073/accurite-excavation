...
faqs:
  - question: "Do I need a septic system for my property in Morgan?"
    answer: "Many properties in Morgan County are outside municipal sewer service areas and require a septic system. The Weber-Morgan Health Department requires a perc test to evaluate your soil's drainage capacity before approving a system design. We handle the full process: test pit excavation, system installation, and final grading. If your property is in the Town of Morgan itself, check with the town office about sewer availability on your specific street."
  - question: "What does excavation cost on a mountain lot in Morgan?"
    answer: "Mountain and foothill lots in Morgan often cost more to excavate than valley floor properties because of rocky soil, steeper grades, and longer access roads. A typical residential foundation dig in Morgan runs $5,000 to $15,000 depending on rock conditions and slope. Properties up East Canyon or near the benches tend to be on the higher end. We do a site visit before quoting so the number reflects your actual ground conditions."
  - question: "Can you build a driveway on a steep Morgan County lot?"
    answer: "Yes. Many Morgan lots, especially those in the foothills or up the canyons, need significant cut-and-fill work just to create drivable access. We handle driveway excavation, grading, and drainage installation. Some properties also need retaining walls along the driveway cut to hold the hillside. We can do the full sequence from raw hillside to finished grade."
  - question: "How long does a septic system installation take in Morgan?"
...
Once the system is designed and permitted, we excavate the tank pit, trench the drain field lines, set the tank, and handle backfill and final grading. We also handle [septic system replacements](/services/septic-systems) for older Morgan properties where the original system has reached the end of its service life — a common issue on properties built in the 1970s and 1980s.
...
We handle full [site clearing and grading](/services/grading-land-clearing) including tree and brush removal, topsoil stripping, rough grading, and pad preparation. Properties with significant slope also need cut-and-fill work and often [retaining walls](/services/rock-walls-retaining-walls) to create a stable building pad.
