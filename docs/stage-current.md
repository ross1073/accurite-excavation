...
- **2026-08-13** — Tone pass on the lot-clearing post (`d711f04`, live). Ross's full rewrite was **not** shipped: it cut 1,453 words to 413, dropped the target phrase, all 13 internal links, and every video reference. Cause of the "unfriendly" read was four anti-competitor sentences, fixed in place; his descriptive H2s adopted. Standing lesson: `~/.claude/projects/-Users-rosswalker/memory/feedback_diff_a_rewrite_against_what_shipped.md`.
- **2026-08-11** — First new blog post since July: `/blog/lot-clearing-and-grading-before-road-construction`, targeting `residential lot clearing and grading` (218 impr @ pos 13.4 in GSC 90d, measured 2026-08-11). Technical vocabulary (grubbing, subgrade, GPS grading) has **no measurable Utah search demand** — don't build on it. Same session: OG image, service-slug, and apple-touch-icon repairs site-wide, plus reusable `VideoObject` schema.

(Earlier entries, including the 2026-07-17 GBP launchd migration and the 2026-07-13 winter
keyword research, are in `docs/stage-history.md`.)
